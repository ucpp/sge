...
namespace SGE
{
    ...
    constexpr uint32 RTT_START_SRV_HEAP_INDEX = CBV_SRV_HEAP_CAPACITY - 30;
    constexpr uint32 DEPTH_BUFFER_START_SRV_HEAP_INDEX = CBV_SRV_HEAP_CAPACITY - 4;
    constexpr uint32 TEXTURES_START_HEAP_INDEX = CBV_SRV_HEAP_CAPACITY - SRV_HEAP_CAPACITY;
    constexpr uint32 EDITOR_START_HEAP_INDEX = CBV_SRV_HEAP_CAPACITY - 70;
